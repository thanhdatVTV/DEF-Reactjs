...
const createPhanCongMonHoc = ({ MaDDK, NganhHoc, MaMH, TenMH, NamHoc, HocKy, CoSo, ToaNha, Phong, TuanHoc, Thu, TietHoc, SiSo, TeacherCode }) => {
    return axios.post(`/api/phan-cong-mon-hoc/add-phan-cong-mon-hoc`, { MaDDK, NganhHoc, MaMH, TenMH, NamHoc, HocKy, CoSo, ToaNha, Phong, TuanHoc, Thu, TietHoc, SiSo, TeacherCode });
}

const updatePhanCongMonHoc = ({ Id, MaDDK, NganhHoc, MaMH, TenMH, NamHoc, HocKy, CoSo, ToaNha, Phong, TuanHoc, Thu, TietHoc, SiSo, TeacherCode }) => {
    console.log('dddd', TuanHoc)
    return axios.post(`/api/phan-cong-mon-hoc/update-phan-cong-mon-hoc`, { Id, MaDDK, NganhHoc, MaMH, TenMH, NamHoc, HocKy, CoSo, ToaNha, Phong, TuanHoc, Thu, TietHoc, SiSo, TeacherCode });
}
